...
return [
    ...
    'storage' => [
        ...
        'single_limit' => 1024 * 1024 * 20, // 单个文件的大小限制，默认200M 1024 * 1024 * 200
        'total_limit' => 1024 * 1024 * 20, // 所有文件的大小限制，默认200M 1024 * 1024 * 200
        'nums' => 2, // 文件数量限制，默认10
        'include' => ['png','jpg','jpeg'], // 被允许的文件类型列表
        'exclude' => ['php','js'], // 不被允许的文件类型列表
        // 本地对象存储
        'local' => [
            'adapter' => \Tinywan\Storage\Adapter\LocalAdapter::class,
            'root' => public_path().'/res/',
            'dirname' => function () {
                return date('Ymd');
            },
            'domain' => "",//getenv('API_URL')
            'uri' => '/res/', // 如果 domain + uri 不在 public 目录下，请做好软链接，否则生成的url无法访问
            'algo' => 'sha1',
        ],
        // 阿里云对象存储
        'oss' => [
